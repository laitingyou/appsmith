...
import SwitchComponent from "../../SwitchWidget/component"
      ...
      const columnData = {
        ...
        Cell: (props: any) => {
          ...
          if (columnProperties.columnType === "button") {
              ...
              columnActions: [
                {
                  id: columnProperties.id,
                  // label: cellProperties.buttonLabel || "Action",
                  dynamicTrigger: columnProperties.onChange || "",
                },
              ],
            ...
            return renderSwitchButton(switchButtonProps, isHidden, cellProperties);
          }else {
            const isCellVisible = cellProperties.isCellVisible ?? true;
            return renderCell(
              props.cell.value,
          ...
          if (column.metaProperties) {
            ...
            switch (type) {
              case ColumnTypes.DATE:
                ...
                break;
              // case ColumnTypes.SWITCH_BUTTON:
              //   // console.log(123123, value);
              //   tableRow[accessor] = <SwitchComponent/>
              //   break
